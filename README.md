...
> ### What is it for?
> 원본 네트워크의 특정한 특성들을 유지한 채 [무작위 네트워크를 생성](#221-무작위-그래프-생성-)하여 원본 네트워크의 고유한 특성을 비교 분석할 수 있다.
>
> 일반적으로 무작위성의 평균적 특성을 보기 위해 [여러 개의 무작위 그래프를 생성](#222-무작위-그래프-앙상블-생성-)한 후 평균값을 이용해 분석한다.
...
> ### 2.2. Analysis [▲](#2-패키지-이용하여-원하는-데이터-분석)
